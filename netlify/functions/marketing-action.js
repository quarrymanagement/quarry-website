...
<div style="text-align:center;margin-bottom:16px;"><div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:11px;color:${CREAM_ON_NAVY};letter-spacing:0.18em;text-transform:uppercase;font-weight:600;margin-bottom:8px;">Follow Us</div><div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;font-weight:600;letter-spacing:0.04em;"><a href="${FB_URL}" style="color:${GOLD_LT};text-decoration:none;">Facebook</a> &nbsp;·&nbsp; <a href="${IG_URL}" style="color:${GOLD_LT};text-decoration:none;">Instagram</a> &nbsp;·&nbsp; <a href="${WEB_URL}" style="color:${GOLD_LT};text-decoration:none;">Website</a></div></div>
<div style="text-align:center;margin-bottom:10px;"><div style="font-family:'Playfair Display',Georgia,serif;font-size:16px;color:${GOLD_LT};font-weight:700;letter-spacing:0.06em;margin-bottom:4px;">The Quarry</div><div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;color:${CREAM_ON_NAVY};line-height:1.5;">3960 Highway Z &nbsp;·&nbsp; New Melle, MO 63385 &nbsp;·&nbsp; <a href="tel:6362248257" style="color:${CREAM_ON_NAVY};text-decoration:none;">(636) 224-8257</a></div></div>
