...
async function sendVisitEmail({ member, visitAmount, basePoints, birthdayBonus, newTier, oldTier, tierChanged }) {
  ...
  const html =
    '<div style="font-family:Georgia,serif;max-width:520px;margin:40px auto;padding:36px;background:#1A1A1A;color:#F5F0E8;border-radius:8px;">' +
      ...
      '<div style="text-align:center;font-style:italic;color:rgba(245,240,232,0.6);margin-bottom:28px;">It was good to have you in.</div>' +
      ...
      '</div>' +
      '<div style="margin-top:24px;font-size:0.7rem;color:rgba(245,240,232,0.4);text-align:center;font-style:italic;">[Test email triggered via /simulate-visit · safe to ignore]</div>' +
      '<div style="margin-top:18px;padding-top:18px;border-top:1px solid rgba(196,149,106,0.15);font-size:0.7rem;color:rgba(245,240,232,0.4);text-align:center;font-family:Arial,sans-serif;">3960 Highway Z · New Melle, MO 63365 · (636) 224-8257</div>' +
    '</div>';
