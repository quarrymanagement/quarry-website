...
exports.handler=async(event)=>{
  ...
  try{
    ...
    const totalRegistered=regs.reduce((s,r)=>s+(r.partySize||1),0);
    return{statusCode:200,headers:h,body:JSON.stringify({...ev,takenTables,takenBarSeats,totalRegistered,registrationCount:regs.length})};
