...
DATA_FILES_REGEX='^(events|bands|marketing_drafts|marketing_calendar|marketing_events|marketing_learnings|marketing_crm|marketing_optimization|subscribers|social_drafts|social_calendar|social_events|social_learnings|social_assets|social_optimization|social_event_ideas|reservations|reservations_status|form_submissions|backup_form_submissions|crm_contacts|send_events|email_history|aggregates|inbox|schedule|ai_learnings)\.json$'
